                ...
                <div>
                    <Card className="customerCard">
                        <div className="CustomerPage">
                            <Typography className="customerDetails" style={{ fontSize: '18px', fontFamily: 'Arial, Helvetica, sans-serif' }}>Customer Details</Typography>
                        ...
                        <div className="textFieldAddress">
                            <TextField id="outlined-multiline-static" label="Address" multiline
                                rows="3" variant="outlined" style={{ width: '450px' }} InputProps={{ disableUnderline: true }} />
                        </div><br></br>
